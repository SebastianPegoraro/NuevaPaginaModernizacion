        ...
        <div class="row">
          <h3>Dirección General de Modernización del Estado</h3>
            ...
            <div class="MultiCarousel-inner Medium">
              ...
              <div class="item">
                <div class="pad15">
                  <img src="img/team/2.jpg" alt="" class="equipo">
                  <p>Edward</p>
                </div>
              </div>
              <div class="item">
                <div class="pad15">
                  <img src="img/team/3.jpg" alt="" class="equipo">
                  <p>Alphonse</p>
                </div>
              </div>
              <div class="item">
                <div class="pad15">
                  <img src="img/team/4.jpg" alt="" class="equipo">
                  <p>Alex</p>
                </div>
              </div>
              <div class="item">
                <div class="pad15">
                  <img src="img/team/5.jpg" alt="" class="equipo">
                  <p>Luis</p>
                </div>
              </div>
              <div class="item">
