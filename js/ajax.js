...
$(document).ready(function() {
    ...
    $(".nombre").keydown(function(event) {
        if (event.keyCode == 13 || event.keyCode == 09) { //la tecla es 13? (13=enter)
            ...
            if ($(this).val() == "") {
                ...
                return;
            } //si el control no tiene texto, ponerle la clase is-invalid (borde rojo) y salir
    ...
    $(".apellido").keydown(function(event) {
        if (event.keyCode == 13 || event.keyCode == 09) {
